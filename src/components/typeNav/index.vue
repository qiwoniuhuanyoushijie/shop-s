<template>
  <div class="type-nav">
    <div class="container">
    <div @mousemove="leaveHandler" @click="goSearch">
                ...
                <dl class="fore" v-for="(c2,index) in c1.categoryChild" :key="c2.categoryId">
                  ...
                  <dd>
                    <em v-for="(c3,index) in c2.categoryChild" :key="c3.categoryId">
                      <a :data-categoryName="c3.categoryName" :data-category3Id="c3.categoryId">婚恋/两性</a>
                    </em>
                    <em>
                      <a href="">文学</a>
                    </em>
    ...
    goSearch(event){
        ...
        if(categoryname){
            ...
            if(category1id){
                ...
                loacations.query.category2id=category2id
            }else{
                loacations.query.category3id=category3id
            }
