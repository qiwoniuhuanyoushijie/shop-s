        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(setAttr, index) in spuSaleAttrList" :key="setAttr.id">
                <dt class="title">{{ setAttr.saleAttrName }}</dt>
                <dd changepirce="0" class="active" v-for="(saleAttrValue, index) in saleAttr.spuSaleAttrValueList"
                  :key="saleAttrValue.id" :class="{ active: saleAttrValue.isChecked == 1 }"
    ...
    addOrUpdateCart() {
      ...
      try {
        await this.$store.dispatch("addOrUpdateCart", {
          skuInfo: this.$route.params.skuInfo,
          skuNum: this.skuNum
        }),
